...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/openchargemap_find_stations \
  -H 'Content-Type: application/json' \
  -d '{"location":"San Francisco","max_results":10}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/openchargemap_find_stations`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
